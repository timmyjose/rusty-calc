...
import { Alert, View, TextInput, Button, Text, StyleSheet, StatusBar, Box } from 'react-native'
...
const Main = () => {
 ...
 return (
   ...
   <Button
      title="Go to Get Permissions"
      onPress={() => navigation.navigate('GetPermissions')}
      />
     <TextInput
